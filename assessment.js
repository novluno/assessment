...
assessmentButton.addEventListener(
  ...
  () => {
    ...
    // headerDivisionの作成
    const headerDivisyon = document.createElement('div');
    headerDivisyon.setAttribute('class','card-header text-bg-primary');
    headerDivisyon.innerText = '診断結果';
    ...
    // resultDivisyon に Bootstrap のスタイルを適用する
    resultDivision.setAttribute('class','card');

    // headerDivisyon と bodyDivisyon を resultDivisyon に差し込む
    resultDivision.appendChild(headerDivisyon);
